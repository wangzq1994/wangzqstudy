...
[![对象内存布局](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E5%AF%B9%E8%B1%A1%E5%9C%A8%E5%86%85%E5%AD%98%E4%B8%AD%E7%9A%84%E5%B8%83%E5%B1%80.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/对象在内存中的布局.png)
...
[![对象头描述](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E5%AF%B9%E8%B1%A1%E5%A4%B4%E7%9A%84%E6%8F%8F%E8%BF%B0.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/对象头的描述.png)
...
[![对象头组成1](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E5%AF%B9%E8%B1%A1%E5%A4%B4%E7%9A%84markword%E7%BB%84%E6%88%901.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/对象头的markword组成1.png)

mark/markword就是说面说过的，保存了对象的GC状态，同步状态和hashcode等信息。

下面是mark/markword的组成(见:markOop.hpp头文件):

[![对象头组成2](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E5%AF%B9%E8%B1%A1%E5%A4%B4%E7%9A%84markword%E7%BB%84%E6%88%902.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/对象头的markword组成2.png)

对象处于不同的同步状态和GC状态，markword都不同(见:markOop.hpp头文件):

[![对象头组成3](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E5%AF%B9%E8%B1%A1%E5%A4%B4%E7%9A%84markword%E7%BB%84%E6%88%903.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/对象头的markword组成3.png)

[![对象头组成4](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E5%AF%B9%E8%B1%A1%E5%A4%B4%E7%9A%84markword%E7%BB%84%E6%88%904.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/对象头的markword组成4.png)
...
[![jol工具查看对象内存布局1](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/jol%E5%B7%A5%E5%85%B7%E6%9F%A5%E7%9C%8B%E5%AF%B9%E8%B1%A1%E5%86%85%E5%AD%98%E5%B8%83%E5%B1%801.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/jol工具查看对象内存布局1.png)
...
[![jol工具查看对象内存布局2](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/jol%E5%B7%A5%E5%85%B7%E6%9F%A5%E7%9C%8B%E5%AF%B9%E8%B1%A1%E5%86%85%E5%AD%98%E5%B8%83%E5%B1%802.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/jol工具查看对象内存布局2.png)
...
[![hashcode方法源码](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/hashcode%E6%96%B9%E6%B3%95%E6%BA%90%E7%A0%81.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/hashcode方法源码.png)
...
[![synchronized底层原理1](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/synchronized%E5%BA%95%E5%B1%82%E5%8E%9F%E7%90%861.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/synchronized底层原理1.png)

使用 javap -c 指令反编译 class文件后的 **字节码指令** 如下

[![synchronized底层原理2](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/synchronized%E5%BA%95%E5%B1%82%E5%8E%9F%E7%90%862.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/synchronized底层原理2.png)
...
[![synchronized底层原理3](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/synchronized%E5%BA%95%E5%B1%82%E5%8E%9F%E7%90%863.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/synchronized底层原理3.png)
...
[![synchronized底层原理4](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/synchronized%E5%BA%95%E5%B1%82%E5%8E%9F%E7%90%864.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/synchronized底层原理4.png)

PS:本来想真正弄清楚fast_enter(偏向锁的实现),slow_enter(轻量级锁实现)和inflate(膨胀锁实现) 的,无奈暂时看不太懂cpp源码，但是有的地方是可以根据语义来推断的。

这里做一个总结吧,这个总结可能不太准确，但大致是这样的: **每次执行monitorenter指令的时候,是将当前synchronized锁对象 关联的**monitor**的_recursions加1, 执行monitorexit指令的时候,将当前object对象关联的**monitor**的_recursions减1, 当_recursions为0的时候，就说明线程不再持有锁对象。**
...
hotspot偏向锁实现(faster_enter): [![偏向锁实现](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E5%81%8F%E5%90%91%E9%94%81%E5%AE%9E%E7%8E%B0.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/偏向锁实现.png)
...
hotspot轻量级锁实现(slow_enter): [![轻量级锁实现](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E8%BD%BB%E9%87%8F%E7%BA%A7%E9%94%81%E5%AE%9E%E7%8E%B0.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/轻量级锁实现.png)
...
[![死锁](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E6%AD%BB%E9%94%81.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/死锁.png)
...
[![Java内存模型](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/Java%E5%86%85%E5%AD%98%E6%A8%A1%E5%9E%8B.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/Java内存模型.png)
...
而这些Atomic原子类的核心是: 类 Unsafe类是个final类，它的核心方法都是native的， 因为Java无法像C/C++一样使用指针来操作内存, Unsafe类就解决了这个问题。
...
[![跳表](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E8%B7%B3%E8%A1%A8.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/跳表.png)
...
[![用户态与内核态](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E7%94%A8%E6%88%B7%E6%80%81%E4%B8%8E%E5%86%85%E6%A0%B8%E6%80%81.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/用户态与内核态.png)
...
[![BIO原理](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/BIO%E5%8E%9F%E7%90%86.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/BIO原理.png)
...
[![NIO原理](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/NIO%E5%8E%9F%E7%90%86.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/NIO原理.png)
...
在多路复用IO模型中,**用户应用进程会调用操作系统的select/poll/epoll函数, 它会使内核同步的轮询指定的socket， (在NIO,socket就是注册到Selector上的SocketChannel,可以允许多个) 直至监听的socket有数据可读或可写，select/poll/epoll函数才会返回, 用户应用进程也会阻塞的等待select/poll/epoll函数返回。** 当select/poll/epoll函数返回后，即某个socket有事件发生了，用户应用进程就会 发起系统调用，处理事件，将socket数据复制到用户进程内，然后进行数据处理。

[![多路复用IO原理](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E5%A4%9A%E8%B7%AF%E5%A4%8D%E7%94%A8IO%E5%8E%9F%E7%90%86.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/多路复用IO原理.png)
...
> **多路复用IO的优点在于内核可以处理多个socket， 相当于一个用户进程(线程)就可以处理多个socket连接。** 这样不仅降低了系统的开销，并且对于需要高并发的应用是非常有利的。 而非阻塞IO和阻塞IO的一个用户应用进程只能处理一个socket， 要想处理多socket，只能新开进程或线程，但这样很消耗系统资源。

**PS: 在多路复用IO模型中, socket一般应该为非阻塞的， 这就是Java中NIO被称为非阻塞IO的原因。 但实际上NIO属于多路复用IO，它是同步阻塞的IO。 具体原因见 [知乎讨论](https://www.zhihu.com/question/37271342)**

**PS: select/poll/epoll函数是多路复用IO模型的基础，所以如果想 深入了解多路复用IO模型，就需要了解这3个函数以及它们的优缺点。**
...
[![信号驱动IO原理](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E4%BF%A1%E5%8F%B7%E9%A9%B1%E5%8A%A8IO%E5%8E%9F%E7%90%86.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/信号驱动IO原理.png)
...
[![异步IO原理](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E5%BC%82%E6%AD%A5IO%E5%8E%9F%E7%90%86.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/异步IO原理.png)
...
[![jdk8之前的jvm内存分区](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/jdk8%E4%B9%8B%E5%89%8D%E7%9A%84JVM%E5%86%85%E5%AD%98%E5%88%86%E5%8C%BA.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/jdk8之前的JVM内存分区.png)

- JDK8之后:
  - 线程私有的部分不变, 线程共享部分的永久代改为了元空间(MetaSpace) (永久代和元空间都是方法区的实现),字符串常量池也移动到了heap空间

[![jdk8之后的jvm内存分区](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/jdk8%E4%B9%8B%E5%90%8E%E7%9A%84jvm%E5%86%85%E5%AD%98%E5%88%86%E5%8C%BA.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/jdk8之后的jvm内存分区.png)
...
[![JVM程序计数器](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/JVM%E7%A8%8B%E5%BA%8F%E8%AE%A1%E6%95%B0%E5%99%A8.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/JVM程序计数器.png)
...
Java虚拟机栈: [![Java虚拟机栈](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/Java%E8%99%9A%E6%8B%9F%E6%9C%BA%E6%A0%88.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/Java虚拟机栈.png)
...
[![局部变量表](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E5%B1%80%E9%83%A8%E5%8F%98%E9%87%8F%E8%A1%A8.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/局部变量表.png)
...
[![Class文件常量池](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/Class%E6%96%87%E4%BB%B6%E5%B8%B8%E9%87%8F%E6%B1%A0.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/Class文件常量池.png)
...
堆: [![堆内存分区](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E5%A0%86%E5%86%85%E5%AD%98%E5%88%86%E5%8C%BA.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/堆内存分区.png)
...
**PS: 使用cglib的库，可以动态生成class， 所以可以使用cglib测试此错误(Metaspace)**
...
[![Class文件结构1](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/Class%E6%96%87%E4%BB%B6%E7%BB%93%E6%9E%841.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/Class文件结构1.png)

使用vim -b filename 以二进制模式编辑class文件， 然后输入 **:%!xxd** 即可查看十六进制的Class文件,如下:

[![Class文件结构2](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/Class%E6%96%87%E4%BB%B6%E7%BB%93%E6%9E%842.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/Class文件结构2.png)
...
[![类的生命周期](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E7%B1%BB%E7%9A%84%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/类的生命周期.png)
...
[![ClassLoader部分注释](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/ClassLoader%E9%83%A8%E5%88%86%E6%B3%A8%E9%87%8A.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/ClassLoader部分注释.png)
...
[![类卸载](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E7%B1%BB%E5%8D%B8%E8%BD%BD.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/类卸载.png)
...
[![双亲委派机制](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E5%8F%8C%E4%BA%B2%E5%A7%94%E6%B4%BE%E6%9C%BA%E5%88%B6.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/双亲委派机制.png)
...
[![可达性算法](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E5%8F%AF%E8%BE%BE%E6%80%A7%E7%AE%97%E6%B3%95.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/可达性算法.png)
...
[![复制算法](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E5%A4%8D%E5%88%B6%E7%AE%97%E6%B3%95.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/复制算法.png)
...
[![标记-清除算法](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E6%A0%87%E8%AE%B0-%E6%B8%85%E9%99%A4%E7%AE%97%E6%B3%95.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/标记-清除算法.png)
...
[![标记-整理算法](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/%E6%A0%87%E8%AE%B0-%E6%95%B4%E7%90%86%E7%AE%97%E6%B3%95.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/标记-整理算法.png)
...
[![G1收集器Region](https://github.com/guang19/framework-learning/raw/dev/img/jdk-jvm-juc/G1%E6%94%B6%E9%9B%86%E5%99%A8Region.png)](https://github.com/guang19/framework-learning/blob/dev/img/jdk-jvm-juc/G1收集器Region.png)
